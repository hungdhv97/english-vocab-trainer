...
**Tests**: Prohibited by Constitution v1.0.0. Do not create or run any automated tests.

**Organization**: Tasks are grouped by user story to enable independent implementation and live verification of each story.
...
- **Single project**: `src/` at repository root (no `tests/` directories)
...
**Independent Verification**: [How to verify this story works on its own (demo/checklist)]
...
- [ ] TXXX [P] Observability dashboards and alerts (Prometheus/Grafana)
...
4. **STOP and VALIDATE**: Verify User Story 1 independently (demo/feature flag)
...
- Each user story should be independently completable and verifiable live
