...
**Tests**: Per Constitution, no tests are allowed. Do not include test tasks.
...
<!-- Tests are disallowed by Constitution -->
...
**Checkpoint**: At this point, User Story 1 should be fully functional and independently validatable
...
4. **STOP and VALIDATE**: Validate User Story 1 independently (manual)
